...
const page = () => {
  return (
    <div className="py-10 px-5 lg:px-0 capitalize">
      ...
      <div className="flex justify-between gap-10 lg:gap-20 lg:pl-20 flex-col-reverse lg:flex-row items-center lg:items-start">
        <div className="text-left w-full lg:w-1/3 flex flex-col mt-20">
          <h1 className="text-3xl font-bold my-5">Our Story</h1>
          <p className="text-sm">
      ...
      <div className="flex py-10 lg:p-20 gap-5 w-full flex-col lg:flex-row items-center">
        <div className="flex gap-10 w-1/2">
          <div className="flex flex-col items-center justify-center lg:w-1/3 gap-5 border border-[#B3B3B3] rounded py-8 px-4  hover:bg-[#DB4444] hover:shadow-lg group text-black hover:text-white">
